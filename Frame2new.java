...
public class Frame2new {
   ...
   private void prepareGUI() {
      ...
      mainFrame.setBounds(130, 10, 500, 50);
   ...
   public void showButtonDemo() {
      ...
      this.headerLabel.setHorizontalAlignment(JLabel.CENTER); // Center align text
      this.headerLabel.setVerticalAlignment(JLabel.CENTER); // Center align text
      this.headerLabel.setOpaque(true);
      this.headerLabel.setBackground(Color.black);
